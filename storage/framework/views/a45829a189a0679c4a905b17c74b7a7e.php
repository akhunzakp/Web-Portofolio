        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <?php $__empty_1 = true; $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="glass-card <?php echo e($span); ?> rounded-3xl overflow-hidden flex flex-col justify-between bg-white border border-slate-200 reveal-on-scroll reveal-fade-up <?php echo e($delayClass); ?>">
                        <div>
                            ...
                            <div class="relative h-48 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col items-center justify-center gap-3">
                                ...
                                <?php if($project->image_path): ?>
                                    <img src="<?php echo e(asset('storage/' . $project->image_path)); ?>" 
                                    alt="<?php echo e($project->title); ?>" 
                                    class="absolute inset-0 w-full h-full object-cover opacity-5 brightness-75 blur-[5px] transition-all duration-300">
                                <?php endif; ?>

                                <div class="relative z-10 w-11 h-11 rounded-2xl bg-gradient-to-br <?php echo e($accent); ?> flex items-center justify-center shadow-lg shadow-black/10 font-bold bg-[#2563EB]">
