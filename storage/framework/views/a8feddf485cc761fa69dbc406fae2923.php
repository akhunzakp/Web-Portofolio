            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-4 relative z-10">
                    ...
                    <?php if(!empty($profile->social_links['github'])): ?>
                        <a href="<?php echo e($profile->social_links['github']); ?>" target="_blank" class="text-slate-400 hover:text-[#2563EB] transition-colors duration-200" title="GitHub">
...
<?php /**PATH C:\Magang\resources\views/index.blade.php ENDPATH**/ ?>