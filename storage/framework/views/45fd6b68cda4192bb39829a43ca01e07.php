...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if($profile->photo_path): ?>
                                <div class="mt-4 p-3 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 inline-block">
                                    ...
                                    <img src="<?php echo e(asset('storage/' . $profile->photo_path)); ?>" 
                                        alt="Current Profile Photo" 
                                        class="h-20 w-20 object-cover rounded-lg shadow-sm mb-2">
                                        
                                    <div class="text-xs text-slate-400">Path: <span class="font-mono text-[10px]"><?php echo e($profile->photo_path); ?></span></div>
                                </div>
                            <?php endif; ?>
...
<?php /**PATH /home/server/Reka/Orientasi-Magang/Putra/Web-Portofolio/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>